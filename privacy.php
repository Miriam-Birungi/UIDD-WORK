...
<section class="privacy-policy">
    <div class="container">
        ...
        <ul>
            <li><strong>Personal Information:</strong> Information you provide when signing up, logging in, or contacting us, such as your name, email address, and password.</li>
            <li><strong>Usage Data:</strong> Information about how you use our website, including pages visited, time spent on the site, and interactions with the content.</li>
            <li><strong>Cookies:</strong> We use cookies to improve your experience on our website. You can manage cookie preferences in your browser settings.</li>
        </ul>
        ...
        <ul>
            ...
            <li>Ensure the security of our services and prevent misuse</li>
        </ul>
